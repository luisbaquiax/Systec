 ...
 * @author luis
 */
@WebServlet(name = "DescargaPDF", urlPatterns = {"/DescargaPDF"})
public class DescargaPDF extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setHeader("Content-disposition", "attachment; filename=reporteVentasSystec.pdf");
        ManejadorReporteVentasPDF reporteVentasPDF = new ManejadorReporteVentasPDF();
        List<Venta> ventas = (List<Venta>) request.getSession().getAttribute("ventas");
        reporteVentasPDF.exportarPDF(response, ventas);
    }
